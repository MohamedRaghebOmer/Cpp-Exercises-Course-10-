...
public:
    ...
    clsAddress(string AddressLine1, string AddressLine2, string PoBox,
        string ZIPCode)
    {
    ...
    clsAddress(clsAddress& old_obj)
    {
        ...
        _AddressLine1 = old_obj.POBox();
        _AddressLine1 = old_obj.ZipCode();
    }
...
int main()
{
    clsAddress Address1("AlMalaab", "MrRagheb", "B324", "1234");
    Address1.Print();
