...
public:
    ...
    clsProgrammer(short ID, string FirstName, string LastName, string Email,
        string PhoneNumber, string Title, string Department, float Salary,
        string MainProgrammingLanguage) :
        clsEmployee(ID, FirstName, LastName, Email, PhoneNumber, Title,
            Department, Salary)
    {
...
int main()
{
    clsProgrammer Programmer(123, "Mohamed", "Ragheb", "mohamedraghebomer@gmail.com",
        "01002608684", "Developer", "A100", 5000, "C++");
    Programmer.Print();
